...
top: false
cover: images/cover_lecture6.jpg
toc: true
mathjax: true
...
summary: CS231n Lecture 6 笔记，聚焦 CNN 架构设计：VGG 的深层同构设计哲学、GoogLeNet 的 Inception 多尺度并行分支、ResNet 的残差连接与恒等映射如何突破深度瓶颈，以及批归一化 BatchNorm 的原理与训练/测试阶段的不同行为。
